...
def node_parralell_test_2(state: PrivateState2)-> OverallState:
...
"""
结果为
{'foo': 'My name', 'user_input': 'My', 'bowen': 'My name'}

1. Bar 即使有写入但并没有在最终结果出现
2. node_2和node_3 之间格式完全不一样，只要key在就能运行。
